...
parser = argparse.ArgumentParser(description="Compare body offsets between two local MuJoCo XML models.")
parser.add_argument("--human-xml", required=True, help="Local human reference XML.")
parser.add_argument("--robot-xml", required=True, help="Local robot reference XML.")
...
for i in range(2):
    xml_path = (args.human_xml, args.robot_xml)[i]
