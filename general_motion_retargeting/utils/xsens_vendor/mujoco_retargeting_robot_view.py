...
if __name__ == "__main__":
    ...
    parser.add_argument("--robot-xml", required=True, help="Local MuJoCo robot XML.")
    parser.add_argument("--motion", required=True, help="Local retargeted motion pkl.")
    parser.add_argument(
        "--output-csv",
        default="output_data/xsens_vendor/replay.csv",
    ...
    d = mujoco_displayanimanim(args.robot_xml, args.motion)
